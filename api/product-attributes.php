<?php 
    ...
    if($productAttributes['code'] !== 200) {
        ...
        foreach($productAttributes['data'] as $item) { 
            $newData[$item['term_name']][] = [
                'term_taxonomy_id' => $item['term_taxonomy_id'], 
                'term_taxonomy_name' => $item['term_taxonomy_name'],
                'term_url' => $item['term_url'],
                'product_term_id' => $item['product_term_id']
            ];
        };
        ...
        echo json_encode([
            'code' => 200, 
            'message' => 'Get product attributes success', 
            'data' => $newData
        ]);
    }
?>