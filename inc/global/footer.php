    ...
    <div class="agile-sometext py-md-5 py-sm-4 py-3">
        <div class="container">
            ...
            <div class="sub-some child-momu mt-4">
                ...
                <ul>
                    <li>
                        <img src="images/pay2.png" alt="test" loading="lazy">
                    </li>
                    <li>
                        <img src="images/pay5.png" alt="test" loading="lazy">
                    </li>
                    <li>
                        <img src="images/pay1.png" alt="test" loading="lazy">
                    </li>
                    <li>
                        <img src="images/pay4.png" alt="test" loading="lazy">
                    </li>
                    <li>
                        <img src="images/pay6.png" alt="test" loading="lazy">
                    </li>
                    <li>
                        <img src="images/pay3.png" alt="test" loading="lazy">
                    </li>
                    <li>
                        <img src="images/pay7.png" alt="test" loading="lazy">
                    </li>
                    <li>
                        <img src="images/pay8.png" alt="test" loading="lazy">
                    </li>
                    <li>
                        <img src="images/pay9.png" alt="test" loading="lazy">
                    </li>
                </ul>
            </div>
            <!-- //payment -->
...
<!-- //copyright -->
<?php include "inc/global/script.php" ?>