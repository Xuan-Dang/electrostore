                                            ...
                                            <ul class="multi-column-dropdown d-flex flex-wrap">
                                                ...
                                                <?php }else { ?>
                                                    <?php foreach($productCategories['data'] as $category) { ?>
                                                        <li>
                                                            <a class="d-block p-2" href="?page=products&url=<?php echo $category['product_category_url'] ?>.<?php echo $category['product_category_id'] ?>"><?php echo $category['product_category_name'] ?></a>
                                                        </li>
                                                    <?php } ?>
                                                <?php } ?>
                                            </ul>
